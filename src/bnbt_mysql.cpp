...
void UTIL_MySQLCreateTables( )
{
	...
	strCreate[5] = "CREATE TABLE IF NOT EXISTS users ( buid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, busername VARCHAR(16) NOT NULL, bmd5 BLOB, bmd5_recover BLOB, bcreated DATETIME NOT NULL, bpasskey CHAR(32) NOT NULL, bemail VARCHAR(80) NOT NULL, baccess TINYINT UNSIGNED NOT NULL DEFAULT 1, bgroup TINYINT UNSIGNED NOT NULL DEFAULT 0, btitle VARCHAR(32) NOT NULL, buploaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bdownloaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bbonus BIGINT UNSIGNED NOT NULL DEFAULT 0, bip VARCHAR(40) NOT NULL, bseeding MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bleeching MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bseedbonus DECIMAL(8,2) NOT NULL DEFAULT 0.00, blast DATETIME NOT NULL, blast_index DATETIME NOT NULL, blast_index_2 DATETIME NOT NULL, blast_offer DATETIME NOT NULL, blast_info DATETIME NOT NULL, bwarned DATETIME NOT NULL, bnote TEXT, binvites SMALLINT UNSIGNED NOT NULL DEFAULT 0, binviter VARCHAR(16) NOT NULL, binviterid MEDIUMINT UNSIGNED NOT NULL, binvitable TINYINT(1) UNSIGNED NOT NULL DEFAULT 1, btalk MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, btalkref MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, btalktorrent MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bperpage SMALLINT UNSIGNED NOT NULL, PRIMARY KEY( buid ), UNIQUE KEY( busername(16) ), INDEX( bpasskey(16) ), INDEX( bemail(16) ) ) ENGINE=InnoDB";
	...
	strCreate[9] = "CREATE TABLE IF NOT EXISTS ips ( bip VARCHAR(40) NOT NULL, bcount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bip(40) ) ) ENGINE=MEMORY";
	strCreate[10] = "CREATE TABLE IF NOT EXISTS announcements ( bid SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT, bposted DATETIME NOT NULL, btitle VARCHAR(255) NOT NULL, bannouncement TEXT, baccess TINYINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid ) ) ENGINE=MyISAM";
	strCreate[11] = "CREATE TABLE IF NOT EXISTS lily ( blilyid VARCHAR(16) NOT NULL, busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bpassword VARCHAR(8) NOT NULL, bdata VARCHAR(64) NOT NULL, PRIMARY KEY( blilyid(16) ) ) ENGINE=MyISAM";
	strCreate[12] = "CREATE TABLE IF NOT EXISTS bookmarks ( busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bhash BLOB, bid MEDIUMINT UNSIGNED NOT NULL, bshare TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( buid, bid ), INDEX( bid ) ) ENGINE=MyISAM";
	strCreate[13] = "CREATE TABLE IF NOT EXISTS friends ( buid MEDIUMINT UNSIGNED NOT NULL, bfriendid MEDIUMINT UNSIGNED NOT NULL, bfriendname VARCHAR(16) NOT NULL, PRIMARY KEY( buid, bfriendid ), INDEX( bfriendid ) ) ENGINE=MyISAM";
	strCreate[14] = "CREATE TABLE IF NOT EXISTS invites ( bcode CHAR(32) NOT NULL, bownerid MEDIUMINT UNSIGNED NOT NULL, bcreated DATETIME NOT NULL, bused TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, binvitee VARCHAR(16) NOT NULL, binviteeid MEDIUMINT UNSIGNED NOT NULL, PRIMARY KEY( bcode(16) ), INDEX( bownerid ) ) ENGINE=MyISAM";
	strCreate[15] = "CREATE TABLE IF NOT EXISTS thanks ( bid MEDIUMINT UNSIGNED NOT NULL, bthankerid MEDIUMINT UNSIGNED NOT NULL, bthanker VARCHAR(16) NOT NULL, bthanktime DATETIME NOT NULL, PRIMARY KEY( bid, bthankerid ), INDEX( bthankerid ) ) ENGINE=MyISAM";
	strCreate[16] = "CREATE TABLE IF NOT EXISTS subs ( bid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, btid MEDIUMINT UNSIGNED NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, busername VARCHAR(16) NOT NULL, bsub VARCHAR(128) NOT NULL, bfilename VARCHAR(255) NOT NULL, bname VARCHAR(255) NOT NULL, bimdbid VARCHAR(16) NOT NULL, buploadtime DATETIME NOT NULL, PRIMARY KEY( bid ), INDEX( btid ), INDEX( bimdbid(9) ) ) ENGINE=MyISAM";
	strCreate[17] = "CREATE TABLE IF NOT EXISTS talk ( bid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bip VARCHAR(40) NOT NULL, bposted DATETIME NOT NULL, btalk TEXT, btalkstore TEXT, breply MEDIUMINT UNSIGNED NOT NULL, breply_real MEDIUMINT UNSIGNED NOT NULL, breplyto VARCHAR(16) NOT NULL, breplytoid MEDIUMINT UNSIGNED NOT NULL, breplytimes MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, brt MEDIUMINT UNSIGNED NOT NULL, brtto VARCHAR(16) NOT NULL, brttoid MEDIUMINT UNSIGNED NOT NULL, brttimes MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid ), INDEX( buid ), INDEX( breply ), INDEX( breply_real ) ) ENGINE=MyISAM";
	strCreate[18] = "CREATE TABLE IF NOT EXISTS talkhome ( buid MEDIUMINT UNSIGNED NOT NULL, bfriendid MEDIUMINT UNSIGNED NOT NULL, btalkid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, btalkid ), INDEX( bfriendid ), INDEX( btalkid ) ) ENGINE=MyISAM";
	strCreate[19] = "CREATE TABLE IF NOT EXISTS talktofriend ( buid MEDIUMINT UNSIGNED NOT NULL, btofriendid MEDIUMINT UNSIGNED NOT NULL, btalkid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, btalkid ), INDEX( btofriendid ), INDEX( btalkid ) ) ENGINE=MyISAM";
	strCreate[20] = "CREATE TABLE IF NOT EXISTS talkref ( busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, breferid MEDIUMINT UNSIGNED NOT NULL, brefid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, brefid ), INDEX( breferid ), INDEX( brefid ) ) ENGINE=MyISAM";
	strCreate[21] = "CREATE TABLE IF NOT EXISTS talktag ( btag VARCHAR(40) NOT NULL, bid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( btag, bid ), INDEX( bid ) ) ENGINE=MyISAM";
	strCreate[22] = "CREATE TABLE IF NOT EXISTS talktorrent ( buid MEDIUMINT UNSIGNED NOT NULL, bfriendid MEDIUMINT UNSIGNED NOT NULL, btid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, btid ), INDEX( bfriendid ), INDEX( btid ) ) ENGINE=MyISAM";
	strCreate[23] = "CREATE TABLE IF NOT EXISTS users_prefs ( buid MEDIUMINT UNSIGNED NOT NULL, bdefaulttag VARCHAR(80) NOT NULL, baddedpassed TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bperpage SMALLINT UNSIGNED NOT NULL, bsavesent TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bmsgcomment TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bmsgcommentbm TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( buid ) ) ENGINE=MyISAM";
	strCreate[24] = "CREATE TABLE IF NOT EXISTS votes ( bid SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT, btitle VARCHAR(255) NOT NULL, bcreated DATETIME NOT NULL, bopen DATETIME NOT NULL, bclosed DATETIME NOT NULL, bvotebonus_min MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotebonus_max MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotecount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid ) ) ENGINE=MyISAM";
	strCreate[25] = "CREATE TABLE IF NOT EXISTS votesoption ( bid SMALLINT UNSIGNED NOT NULL, boptionid TINYINT UNSIGNED NOT NULL, boption VARCHAR(255) NOT NULL, bvotecount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid, boptionid ) ) ENGINE=MyISAM";
	strCreate[26] = "CREATE TABLE IF NOT EXISTS votesticket ( bid SMALLINT UNSIGNED NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, boptionid TINYINT UNSIGNED NOT NULL, bvotebonus MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotetime DATETIME NOT NULL, PRIMARY KEY( bid, buid ) ) ENGINE=MyISAM";
