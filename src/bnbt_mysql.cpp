...
void UTIL_MySQLCreateTables( )
{
	...
	strCreate[3] = "CREATE TABLE IF NOT EXISTS dstate_store ( bhash BLOB, bid MEDIUMINT UNSIGNED NOT NULL, bpeerid BLOB, buseragent VARCHAR(40) NOT NULL, busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bip VARCHAR(40) NOT NULL, bip6 VARCHAR(40) NOT NULL, bport SMALLINT UNSIGNED NOT NULL, bkey BLOB, buploaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bdownloaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bleft BIGINT UNSIGNED NOT NULL, bconnected DATETIME NOT NULL, bupdated DATETIME NOT NULL, bcompleted TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bkeeptime INT UNSIGNED NOT NULL DEFAULT 0, bupspeed BIGINT UNSIGNED NOT NULL DEFAULT 0, bdownspeed BIGINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid, buid, bpeerid(20) ), INDEX( buid ), INDEX( bip(16) ), INDEX( bip6(32) ) ) ENGINE=InnoDB";
	strCreate[4] = "CREATE TABLE IF NOT EXISTS peers ( bhash BLOB, bid MEDIUMINT UNSIGNED NOT NULL, busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bip VARCHAR(40) NOT NULL, buploaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bdownloaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bstarted DATETIME NOT NULL, bcompleted DATETIME NOT NULL, INDEX( bid, buid ), INDEX( buid ) ) ENGINE=MyISAM";
	...
	strCreate[13] = "CREATE TABLE IF NOT EXISTS bookmarks ( busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bhash BLOB, bid MEDIUMINT UNSIGNED NOT NULL, bshare TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( buid, bid ), INDEX( bid ) ) ENGINE=MyISAM";
	...
	strCreate[25] = "CREATE TABLE IF NOT EXISTS users_prefs ( buid MEDIUMINT UNSIGNED NOT NULL, bdefaulttag VARCHAR(80) NOT NULL, baddedpassed TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bperpage SMALLINT UNSIGNED NOT NULL, bsavesent TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bmsgcomment TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bmsgcommentbm TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( buid ) ) ENGINE=MyISAM";
	...
	strCreate[29] = "CREATE TABLE IF NOT EXISTS notes ( bid MEDIUMINT UNSIGNED NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bnote VARCHAR(64) NOT NULL, PRIMARY KEY( bid, buid, bnote ), INDEX( buid ), INDEX( bnote(16) ) ) ENGINE=MyISAM";
