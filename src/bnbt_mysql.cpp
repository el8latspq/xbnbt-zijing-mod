...
void UTIL_MySQLCreateTables( )
{
	...
	strCreate[17] = "CREATE TABLE IF NOT EXISTS talk ( bid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, bip VARCHAR(40) NOT NULL, bposted DATETIME NOT NULL, btalk TEXT, btalkstore TEXT, breply MEDIUMINT UNSIGNED NOT NULL, breplyto VARCHAR(16) NOT NULL, breplytoid MEDIUMINT UNSIGNED NOT NULL, breplytimes MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, brt MEDIUMINT UNSIGNED NOT NULL, brtto VARCHAR(16) NOT NULL, brttoid MEDIUMINT UNSIGNED NOT NULL, brttimes MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid ), INDEX( buid ), INDEX( breply ) ) ENGINE=MyISAM";
	...
	strCreate[19] = "CREATE TABLE IF NOT EXISTS talkref ( busername VARCHAR(16) NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, breferid MEDIUMINT UNSIGNED NOT NULL, brefid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, brefid ), INDEX( breferid ), INDEX( brefid ) ) ENGINE=MyISAM";
	strCreate[20] = "CREATE TABLE IF NOT EXISTS talktag ( btag VARCHAR(40) NOT NULL, bid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( btag, bid ), INDEX( bid ) ) ENGINE=MyISAM";
	strCreate[21] = "CREATE TABLE IF NOT EXISTS talktorrent ( buid MEDIUMINT UNSIGNED NOT NULL, bfriendid MEDIUMINT UNSIGNED NOT NULL, btid MEDIUMINT UNSIGNED NOT NULL, bposted DATETIME NOT NULL, PRIMARY KEY( buid, btid ), INDEX( bfriendid ), INDEX( btid ) ) ENGINE=MyISAM";
	strCreate[22] = "CREATE TABLE IF NOT EXISTS users_prefs ( buid MEDIUMINT UNSIGNED NOT NULL, bdefaulttag VARCHAR(80) NOT NULL, baddedpassed TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bperpage SMALLINT UNSIGNED NOT NULL, bsavesent TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, bmsgcomment TINYINT(1) UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( buid ) ) ENGINE=MyISAM";
	strCreate[23] = "CREATE TABLE IF NOT EXISTS votes ( bid SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT, btitle VARCHAR(255) NOT NULL, bcreated DATETIME NOT NULL, bopen DATETIME NOT NULL, bclosed DATETIME NOT NULL, bvotebonus_min MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotebonus_max MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotecount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid ) ) ENGINE=MyISAM";
	strCreate[24] = "CREATE TABLE IF NOT EXISTS votesoption ( bid SMALLINT UNSIGNED NOT NULL, boptionid TINYINT UNSIGNED NOT NULL, boption VARCHAR(255) NOT NULL, bvotecount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, PRIMARY KEY( bid, boptionid ) ) ENGINE=MyISAM";
	strCreate[25] = "CREATE TABLE IF NOT EXISTS votesticket ( bid SMALLINT UNSIGNED NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, boptionid TINYINT UNSIGNED NOT NULL, bvotebonus MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bvotetime DATETIME NOT NULL, PRIMARY KEY( bid, buid ) ) ENGINE=MyISAM";
