...
void UTIL_MySQLCreateTables( )
{
	...
	strCreate[15] = "CREATE TABLE IF NOT EXISTS thanks ( bid MEDIUMINT UNSIGNED NOT NULL, bthankerid MEDIUMINT UNSIGNED NOT NULL, bthanker VARCHAR(16) NOT NULL, bthanktime DATETIME NOT NULL, PRIMARY KEY( bid, bthankerid ) ) ENGINE=MyISAM";
	strCreate[16] = "CREATE TABLE IF NOT EXISTS subs ( bid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, btid MEDIUMINT UNSIGNED NOT NULL, buid MEDIUMINT UNSIGNED NOT NULL, busername VARCHAR(16) NOT NULL, bsub VARCHAR(128) NOT NULL, bfilename VARCHAR(255) NOT NULL, bname VARCHAR(255) NOT NULL, buploadtime DATETIME NOT NULL, PRIMARY KEY( bid ), INDEX( btid ) ) ENGINE=MyISAM";
