...
void UTIL_MySQLCreateTables( )
{
	...
	strCreate[5] = "CREATE TABLE IF NOT EXISTS users ( buid MEDIUMINT UNSIGNED NOT NULL AUTO_INCREMENT, busername VARCHAR(16) NOT NULL, bmd5 BLOB, bmd5_recover BLOB, bcreated DATETIME NOT NULL, bpasskey CHAR(32) NOT NULL, bemail VARCHAR(80) NOT NULL, baccess TINYINT UNSIGNED NOT NULL DEFAULT 1, bgroup TINYINT UNSIGNED NOT NULL DEFAULT 0, btitle VARCHAR(32) NOT NULL, buploaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bdownloaded BIGINT UNSIGNED NOT NULL DEFAULT 0, bbonus BIGINT UNSIGNED NOT NULL DEFAULT 0, bip VARCHAR(40) NOT NULL, bseeding MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bleeching MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bseedbonus DECIMAL(8,2) NOT NULL DEFAULT 0.00, blast DATETIME NOT NULL, blast_index DATETIME NOT NULL, blast_index_2 DATETIME NOT NULL, blast_offer DATETIME NOT NULL, blast_info DATETIME NOT NULL, bwarned DATETIME NOT NULL, bnote TEXT, binvites SMALLINT UNSIGNED NOT NULL DEFAULT 0, binviter VARCHAR(16) NOT NULL, binviterid MEDIUMINT UNSIGNED NOT NULL, btalk MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, btalkref MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, btalktorrent MEDIUMINT UNSIGNED NOT NULL DEFAULT 0, bperpage SMALLINT UNSIGNED NOT NULL, PRIMARY KEY( buid ), UNIQUE KEY( busername(16) ), INDEX( bpasskey(16) ), INDEX( bemail(16) ) ) ENGINE=InnoDB";
